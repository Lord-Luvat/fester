...
describe('EthService unit tests', () => {
    ...
    describe('fetchBlockDetails()', () => {
        ...
        it('should update latest base fee per gas', () => {
            const expectedBaseFee = Number(mockWeb3.utils.fromWei('1000000000', 'gwei'));
        ...
        it('should calculate and update latest average priority fee', () => {
            ...
            const expectedAveragePriorityFee = mockWeb3.utils.fromWei(averagePriorityFee, 'gwei');
            expect(ethService.latestAveragePriorityFee).toBe(expectedAveragePriorityFee);
        });
